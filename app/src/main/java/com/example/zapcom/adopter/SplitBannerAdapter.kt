...
class SplitBannerAdapter(private val items: List<Item>) : RecyclerView.Adapter<SplitBannerAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.splitbanner_item, parent, false)
